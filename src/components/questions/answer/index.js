...
class Answer extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            selected: this.props.defaultAnswer,
        }
    }
        ...
        return(
            <div className="container">
                <div className="answers">
                    ...
                    <div onClick={() => this.select(4)} className={"circle good r4" + (this.state.selected === 4 ? " selected" : "")}>{ this.state.selected === 4 && <img className="t4" src={tick}/> }</div>
                    <div onClick={() => this.select(3)} className={"circle good r3" + (this.state.selected === 3 ? " selected" : "")}>{ this.state.selected === 3 && <img className="t3" src={tick}/> }</div>
                    ...
                    <div onClick={() => this.select(1)} className={"circle bad r4" + (this.state.selected === 1 ? " selected" : "")}>{ this.state.selected === 1 && <img className="t4" src={tick}/> }</div>
